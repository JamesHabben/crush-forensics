...
- Fixed opening an encrypted 7z archive's content with the wrong password sometimes raising an unhandled `CrcError` instead of the expected password error, on macOS.
